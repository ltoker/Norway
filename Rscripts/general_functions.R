...
packageF("car")
packageF("corpcor")
#install.packages("http://cran.r-project.org/src/contrib/Archive/igraph/igraph_0.7.1.tar.gz", repos=NULL, type="source")
packageF("igraph")
packageF("magrittr")
packageF("sm")
packageF("ggplot2")
...
QCfun <- function(affydata, QC=1, MetaArray ) {
  if(QC == 1) {
    #Run QC
